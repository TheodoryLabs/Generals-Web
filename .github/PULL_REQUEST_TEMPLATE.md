...
<!-- What does this change, and why? Link related issues: "Fixes #123", "Relates to #456". -->
...
<!-- Be specific: "boots to main menu", "started a skirmish and played 5 minutes",
     "verified save/load round-trip via IndexedDB", "confirmed no new console errors"... -->

## Browsers tested

<!-- Check what you actually ran, with versions. -->
