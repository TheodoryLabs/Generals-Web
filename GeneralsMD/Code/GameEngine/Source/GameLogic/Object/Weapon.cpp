...
//-------------------------------------------------------------------------------------------------
static void parsePerVetLevelAsciiString(INI *ini, void * /*instance*/,
                                        void *store,
                                        const void * /*userData*/) {
  AsciiString *s = (AsciiString *)store;
  VeterancyLevel v = (VeterancyLevel)INI::scanIndexList(ini->getNextToken(),
                                                        TheVeterancyNames);
  s[v] = ini->getNextAsciiString();
}

//-------------------------------------------------------------------------------------------------
static void parseAllVetLevelsAsciiString(INI *ini, void * /*instance*/,
                                         void *store,
                                         const void * /*userData*/) {
  AsciiString *s = (AsciiString *)store;
...
//-------------------------------------------------------------------------------------------------
static void parsePerVetLevelFXList(INI *ini, void * /*instance*/, void *store,
                                   const void * /*userData*/) {
...
//-------------------------------------------------------------------------------------------------
static void parseAllVetLevelsFXList(INI *ini, void * /*instance*/, void *store,
                                    const void * /*userData*/) {
  typedef const FXList *ConstFXListPtr;
  ConstFXListPtr *s = (ConstFXListPtr *)store;
  const FXList *fx = nullptr;
...
//-------------------------------------------------------------------------------------------------
static void parsePerVetLevelPSys(INI *ini, void * /*instance*/, void *store,
                                 const void * /*userData*/) {
...
//-------------------------------------------------------------------------------------------------
static void parseAllVetLevelsPSys(INI *ini, void * /*instance*/, void *store,
                                  const void * /*userData*/) {
  typedef const ParticleSystemTemplate *ConstParticleSystemTemplatePtr;
  ConstParticleSystemTemplatePtr *s = (ConstParticleSystemTemplatePtr *)store;
  ConstParticleSystemTemplatePtr pst = nullptr;
...
const FieldParse WeaponTemplate::TheWeaponTemplateFieldParseTable[] = {
    ...
    {"PrimaryDamage", INI::parseReal, nullptr,
     offsetof(WeaponTemplate, m_primaryDamage)},
    {"PrimaryDamageRadius", INI::parseReal, nullptr,
     offsetof(WeaponTemplate, m_primaryDamageRadius)},
    {"SecondaryDamage", INI::parseReal, nullptr,
     offsetof(WeaponTemplate, m_secondaryDamage)},
    {"SecondaryDamageRadius", INI::parseReal, nullptr,
     offsetof(WeaponTemplate, m_secondaryDamageRadius)},
    {"ShockWaveAmount", INI::parseReal, nullptr,
     offsetof(WeaponTemplate, m_shockWaveAmount)},
    {"ShockWaveRadius", INI::parseReal, nullptr,
     offsetof(WeaponTemplate, m_shockWaveRadius)},
    {"ShockWaveTaperOff", INI::parseReal, nullptr,
     offsetof(WeaponTemplate, m_shockWaveTaperOff)},
    {"AttackRange", INI::parseReal, nullptr,
     offsetof(WeaponTemplate, m_attackRange)},
    {"MinimumAttackRange", INI::parseReal, nullptr,
     offsetof(WeaponTemplate, m_minimumAttackRange)},
    {"RequestAssistRange", INI::parseReal, nullptr,
     offsetof(WeaponTemplate, m_requestAssistRange)},
    {"AcceptableAimDelta", INI::parseAngleReal, nullptr,
     offsetof(WeaponTemplate, m_aimDelta)},
    {"ScatterRadius", INI::parseReal, nullptr,
     offsetof(WeaponTemplate, m_scatterRadius)},
    {"ScatterTargetScalar", INI::parseReal, nullptr,
     offsetof(WeaponTemplate, m_scatterTargetScalar)},
    {"ScatterRadiusVsInfantry", INI::parseReal, nullptr,
     offsetof(WeaponTemplate, m_infantryInaccuracyDist)},
    {"DamageType", DamageTypeFlags::parseSingleBitFromINI, nullptr,
     offsetof(WeaponTemplate, m_damageType)},
    {"DamageStatusType", ObjectStatusMaskType::parseSingleBitFromINI, nullptr,
     offsetof(WeaponTemplate, m_damageStatusType)},
    {"DeathType", INI::parseIndexList, TheDeathNames,
     offsetof(WeaponTemplate, m_deathType)},
    {"WeaponSpeed", INI::parseVelocityReal, nullptr,
     offsetof(WeaponTemplate, m_weaponSpeed)},
    {"MinWeaponSpeed", INI::parseVelocityReal, nullptr,
     offsetof(WeaponTemplate, m_minWeaponSpeed)},
    {"ScaleWeaponSpeed", INI::parseBool, nullptr,
     offsetof(WeaponTemplate, m_isScaleWeaponSpeed)},
    {"WeaponRecoil", INI::parseAngleReal, nullptr,
     offsetof(WeaponTemplate, m_weaponRecoil)},
    {"MinTargetPitch", INI::parseAngleReal, nullptr,
     offsetof(WeaponTemplate, m_minTargetPitch)},
    {"MaxTargetPitch", INI::parseAngleReal, nullptr,
     offsetof(WeaponTemplate, m_maxTargetPitch)},
    {"RadiusDamageAngle", INI::parseAngleReal, nullptr,
     offsetof(WeaponTemplate, m_radiusDamageAngle)},
    {"ProjectileObject", INI::parseAsciiString, nullptr,
     offsetof(WeaponTemplate, m_projectileName)},
    {"FireSound", INI::parseAudioEventRTS, nullptr,
     offsetof(WeaponTemplate, m_fireSound)},
    {"FireSoundLoopTime", INI::parseDurationUnsignedInt, nullptr,
     offsetof(WeaponTemplate, m_fireSoundLoopTime)},
    {"FireFX", parseAllVetLevelsFXList, nullptr,
     offsetof(WeaponTemplate, m_fireFXs)},
    {"ProjectileDetonationFX", parseAllVetLevelsFXList, nullptr,
     offsetof(WeaponTemplate, m_projectileDetonateFXs)},
    {"FireOCL", parseAllVetLevelsAsciiString, nullptr,
     offsetof(WeaponTemplate, m_fireOCLNames)},
    {"ProjectileDetonationOCL", parseAllVetLevelsAsciiString, nullptr,
     offsetof(WeaponTemplate, m_projectileDetonationOCLNames)},
    {"ProjectileExhaust", parseAllVetLevelsPSys, nullptr,
     offsetof(WeaponTemplate, m_projectileExhausts)},
    {"VeterancyFireFX", parsePerVetLevelFXList, nullptr,
     offsetof(WeaponTemplate, m_fireFXs)},
    {"VeterancyProjectileDetonationFX", parsePerVetLevelFXList, nullptr,
     offsetof(WeaponTemplate, m_projectileDetonateFXs)},
    {"VeterancyFireOCL", parsePerVetLevelAsciiString, nullptr,
     offsetof(WeaponTemplate, m_fireOCLNames)},
    {"VeterancyProjectileDetonationOCL", parsePerVetLevelAsciiString, nullptr,
     offsetof(WeaponTemplate, m_projectileDetonationOCLNames)},
    {"VeterancyProjectileExhaust", parsePerVetLevelPSys, nullptr,
     offsetof(WeaponTemplate, m_projectileExhausts)},
    {"ClipSize", INI::parseInt, nullptr, offsetof(WeaponTemplate, m_clipSize)},
    {"ContinuousFireOne", INI::parseInt, nullptr,
     offsetof(WeaponTemplate, m_continuousFireOneShotsNeeded)},
    {"ContinuousFireTwo", INI::parseInt, nullptr,
     offsetof(WeaponTemplate, m_continuousFireTwoShotsNeeded)},
    {"ContinuousFireCoast", INI::parseDurationUnsignedInt, nullptr,
     offsetof(WeaponTemplate, m_continuousFireCoastFrames)},
    {"AutoReloadWhenIdle", INI::parseDurationUnsignedInt, nullptr,
     offsetof(WeaponTemplate, m_autoReloadWhenIdleFrames)},
    {"ClipReloadTime", INI::parseDurationUnsignedInt, nullptr,
     offsetof(WeaponTemplate, m_clipReloadTime)},
    {"DelayBetweenShots", WeaponTemplate::parseShotDelay, nullptr, 0},
    {"ShotsPerBarrel", INI::parseInt, nullptr,
     offsetof(WeaponTemplate, m_shotsPerBarrel)},
    {"DamageDealtAtSelfPosition", INI::parseBool, nullptr,
     offsetof(WeaponTemplate, m_damageDealtAtSelfPosition)},
    {"RadiusDamageAffects", INI::parseBitString32, TheWeaponAffectsMaskNames,
     offsetof(WeaponTemplate, m_affectsMask)},
    {"ProjectileCollidesWith", INI::parseBitString32, TheWeaponCollideMaskNames,
     offsetof(WeaponTemplate, m_collideMask)},
    {"AntiAirborneVehicle", INI::parseBitInInt32,
     (void *)WEAPON_ANTI_AIRBORNE_VEHICLE,
     offsetof(WeaponTemplate, m_antiMask)},
    {"AntiGround", INI::parseBitInInt32, (void *)WEAPON_ANTI_GROUND,
     offsetof(WeaponTemplate, m_antiMask)},
    {"AntiProjectile", INI::parseBitInInt32, (void *)WEAPON_ANTI_PROJECTILE,
     offsetof(WeaponTemplate, m_antiMask)},
    {"AntiSmallMissile", INI::parseBitInInt32,
     (void *)WEAPON_ANTI_SMALL_MISSILE, offsetof(WeaponTemplate, m_antiMask)},
    {"AntiMine", INI::parseBitInInt32, (void *)WEAPON_ANTI_MINE,
     offsetof(WeaponTemplate, m_antiMask)},
    {"AntiParachute", INI::parseBitInInt32, (void *)WEAPON_ANTI_PARACHUTE,
     offsetof(WeaponTemplate, m_antiMask)},
    {"AntiAirborneInfantry", INI::parseBitInInt32,
     (void *)WEAPON_ANTI_AIRBORNE_INFANTRY,
     offsetof(WeaponTemplate, m_antiMask)},
    {"AntiBallisticMissile", INI::parseBitInInt32,
     (void *)WEAPON_ANTI_BALLISTIC_MISSILE,
     offsetof(WeaponTemplate, m_antiMask)},
    {"AutoReloadsClip", INI::parseIndexList, TheWeaponReloadNames,
     offsetof(WeaponTemplate, m_reloadType)},
    {"ProjectileStreamName", INI::parseAsciiString, nullptr,
     offsetof(WeaponTemplate, m_projectileStreamName)},
    {"LaserName", INI::parseAsciiString, nullptr,
     offsetof(WeaponTemplate, m_laserName)},
    {"LaserBoneName", INI::parseAsciiString, nullptr,
     offsetof(WeaponTemplate, m_laserBoneName)},
    {"WeaponBonus", WeaponTemplate::parseWeaponBonusSet, nullptr, 0},
    {"HistoricBonusTime", INI::parseDurationUnsignedInt, nullptr,
     offsetof(WeaponTemplate, m_historicBonusTime)},
    {"HistoricBonusRadius", INI::parseReal, nullptr,
     offsetof(WeaponTemplate, m_historicBonusRadius)},
    {"HistoricBonusCount", INI::parseInt, nullptr,
     offsetof(WeaponTemplate, m_historicBonusCount)},
    {"HistoricBonusWeapon", INI::parseWeaponTemplate, nullptr,
     offsetof(WeaponTemplate, m_historicBonusWeapon)},
    {"LeechRangeWeapon", INI::parseBool, nullptr,
     offsetof(WeaponTemplate, m_leechRangeWeapon)},
    {"ScatterTarget", WeaponTemplate::parseScatterTarget, nullptr, 0},
    {"CapableOfFollowingWaypoints", INI::parseBool, nullptr,
     offsetof(WeaponTemplate, m_capableOfFollowingWaypoint)},
    {"ShowsAmmoPips", INI::parseBool, nullptr,
     offsetof(WeaponTemplate, m_isShowsAmmoPips)},
    {"AllowAttackGarrisonedBldgs", INI::parseBool, nullptr,
     offsetof(WeaponTemplate, m_allowAttackGarrisonedBldgs)},
    {"PlayFXWhenStealthed", INI::parseBool, nullptr,
     offsetof(WeaponTemplate, m_playFXWhenStealthed)},
    {"PreAttackDelay", INI::parseDurationUnsignedInt, nullptr,
     offsetof(WeaponTemplate, m_preAttackDelay)},
    {"PreAttackType", INI::parseIndexList, TheWeaponPrefireNames,
     offsetof(WeaponTemplate, m_prefireType)},
    {"ContinueAttackRange", INI::parseReal, nullptr,
     offsetof(WeaponTemplate, m_continueAttackRange)},
    {"SuspendFXDelay", INI::parseDurationUnsignedInt, nullptr,
     offsetof(WeaponTemplate, m_suspendFXDelay)},
    {"MissileCallsOnDie", INI::parseBool, nullptr,
     offsetof(WeaponTemplate, m_dieOnDetonate)},
...
WeaponTemplate::WeaponTemplate() : m_nextTemplate(nullptr) {
  ...
  m_affectsMask = (WEAPON_AFFECTS_ALLIES | WEAPON_AFFECTS_ENEMIES |
                   WEAPON_AFFECTS_NEUTRALS);
  // most projectile weapons don't want to collide with nontargeted
  // enemies/allies or trees...
...
// ------------------------------------------------------------------------------------------------
void WeaponTemplate::reset() { m_historicDamage.clear(); }
...
//-------------------------------------------------------------------------------------------------
/*static*/ void WeaponTemplate::parseScatterTarget(INI *ini, void *instance,
                                                   void * /*store*/,
                                                   const void * /*userData*/) {
...
//-------------------------------------------------------------------------------------------------
/*static*/ void WeaponTemplate::parseShotDelay(INI *ini, void *instance,
                                               void * /*store*/,
                                               const void * /*userData*/) {
  // This smart parser allows both a single number for traditional delay, and a
  // labeled pair of numbers for a delay range
  WeaponTemplate *self = (WeaponTemplate *)instance;
  ...
  if (stricmp(token, MIN_LABEL) == 0) {
    ...
    self->m_minDelayBetweenShots =
        INI::scanInt(ini->getNextToken(ini->getSepsColon()));
  ...
  // ShotDelay used to use parseDurationUnsignedInt, and we are expanding on
  // that.
  self->m_minDelayBetweenShots = ceilf(
      ConvertDurationFromMsecsToFrames((Real)self->m_minDelayBetweenShots));
  self->m_maxDelayBetweenShots = ceilf(
      ConvertDurationFromMsecsToFrames((Real)self->m_maxDelayBetweenShots));
}
...
void WeaponTemplate::postProcessLoad() {
  ...
  if (m_projectileName.isEmpty()) {
    ...
    DEBUG_ASSERTCRASH(m_projectileTmpl,
                      ("projectile %s not found!", m_projectileName.str()));
  }
  ...
  for (Int i = LEVEL_FIRST; i <= LEVEL_LAST; ++i) {
    ...
    if (m_fireOCLNames[i].isEmpty()) {
      ...
      m_fireOCLs[i] = TheObjectCreationListStore->findObjectCreationList(
          m_fireOCLNames[i].str());
      DEBUG_ASSERTCRASH(m_fireOCLs[i], ("OCL %s not found in a weapon!",
                                        m_fireOCLNames[i].str()));
    }
    m_fireOCLNames[i].clear();
    ...
    if (m_projectileDetonationOCLNames[i].isEmpty()) {
      ...
      m_projectileDetonationOCLs[i] =
          TheObjectCreationListStore->findObjectCreationList(
              m_projectileDetonationOCLNames[i].str());
      DEBUG_ASSERTCRASH(m_projectileDetonationOCLs[i],
...
Real WeaponTemplate::getAttackRange(const WeaponBonus &bonus) const {
  ...
  // Note - undersize by 1/4 of a pathfind cell, so that the goal is not
  // teetering on the edge of firing range.  jba.
  ...
  return m_attackRange * bonus.getField(WeaponBonus::RANGE) *
         ATTACK_RANGE_FUDGE;
#endif
}
...
//-------------------------------------------------------------------------------------------------
Real WeaponTemplate::getUnmodifiedAttackRange() const { return m_attackRange; }
...
Int WeaponTemplate::getDelayBetweenShots(const WeaponBonus &bonus) const {
  ...
  if (m_minDelayBetweenShots == m_maxDelayBetweenShots)
    delayToUse =
        m_minDelayBetweenShots; // Random number thing doesn't like this case
  else
    delayToUse =
        GameLogicRandomValue(m_minDelayBetweenShots, m_maxDelayBetweenShots);

  Real bonusROF = bonus.getField(WeaponBonus::RATE_OF_FIRE);
  // CRCDEBUG_LOG(("WeaponTemplate::getDelayBetweenShots() - min:%d max:%d
  // val:%d, bonusROF=%g/%8.8X", m_minDelayBetweenShots, m_maxDelayBetweenShots,
  // delayToUse, bonusROF, AS_INT(bonusROF)));
...
Int WeaponTemplate::getClipReloadTime(const WeaponBonus &bonus) const {
  ...
  return REAL_TO_INT_FLOOR(m_clipReloadTime /
...
Real WeaponTemplate::estimateWeaponTemplateDamage(
    const Object *sourceObj, const Object *victimObj, const Coord3D *victimPos,
  ...
  if (victimObj->isKindOf(KINDOF_SHRUBBERY)) {
    if (deathType == DEATH_BURNED) {
      // this is just a nonzero value, to ensure we can target shrubbery with
      // flame weapons, regardless...
      return 1.0f;
    } else {
      return 0.0f;
    }
  ...
  // hmm.. must be shooting a firebase or such, if there is noone home to take
  // the bullet, return 0!
  ...
  if (damageType == DAMAGE_SURRENDER || m_allowAttackGarrisonedBldgs) {
    ...
    if (contain && contain->getContainCount() > 0 &&
      ...
      // this is just a nonzero value, to ensure we can target garrisoned things
      // with surrender weapons, regardless...
      return 1.0f;
    }
  }

  if (damageType == DAMAGE_DISARM) {
    if (victimObj->isKindOf(KINDOF_MINE) ||
        victimObj->isKindOf(KINDOF_BOOBY_TRAP) ||
        victimObj->isKindOf(KINDOF_DEMOTRAP)) {
      // this is just a nonzero value, to ensure we can target mines with disarm
      // weapons, regardless...
      return 1.0f;
    }
    return 0.0f;
  ...
  //@todo Kris need to examine the DAMAGE_HACK type for damage estimation
  //purposes. Likely this damage type will have threat implications that won't
  // properly be dealt with until resolved.
...
Bool WeaponTemplate::shouldProjectileCollideWith(
    const Object *projectileLauncher, const Object *projectile,
  ...
  // if it's our intended victim, we want to collide with it, regardless of any
  ...
  if (projectileLauncher != nullptr) {
    ...
    // If our launcher is inside something, and that something is
    // 'thingWeCollidedWith' we won't collide
  ...
  if (getDamageType() == DAMAGE_FLAME ||
      getDamageType() == DAMAGE_PARTICLE_BEAM) {
    if (thingWeCollidedWith->testStatus(OBJECT_STATUS_BURNED)) {
      return false;
    }
  }

  // horrible special case for airplanes sitting on airfields: the projectile
  // might "collide" with the airfield's (invisible) collision geometry when a
  // resting plane is targeted. we don't want this. special case it:
  if (thingWeCollidedWith->isKindOf(KINDOF_FS_AIRFIELD)) {
    //
    // ok, so if we are an airfield, and our intended victim has a reserved
    // space with us, it "belongs" to us and collisions intended for it should
    // not detonate as a result of colliding with us.
    //
    // notes:
    //	-- we have already established that "thingWeCollidedWith" is not the
    //intended victim (above)
    //	-- this does NOT verify that the plane is actually parked at the
    //airfield; it might be elsewhere 			(but if it is, it's highly unlikely that
    //this sort of collision could occur)
    //
    for (BehaviorModule **i = thingWeCollidedWith->getBehaviorModules(); *i;
         ++i) {
      ParkingPlaceBehaviorInterface *pp =
          (*i)->getParkingPlaceBehaviorInterface();
      if (pp != nullptr && pp->hasReservedSpace(intendedVictimID))
        return false;
    }
  }

  // if something has a Sneaky Target offset, it is momentarily immune to being
  // hit... normally this shouldn't happen, but occasionally can by accident. so
  // avoid it. (srj)
  ...
  if (thingWeCollidedWith->isKindOf(KINDOF_STRUCTURE)) {
    if (thingWeCollidedWith->getControllingPlayer() ==
        projectile->getControllingPlayer())
      requiredMask |= WEAPON_COLLIDE_CONTROLLED_STRUCTURES;
    else
      requiredMask |= WEAPON_COLLIDE_STRUCTURES;
  }
  if (thingWeCollidedWith->isKindOf(KINDOF_SHRUBBERY))
    requiredMask |= WEAPON_COLLIDE_SHRUBBERY;
  if (thingWeCollidedWith->isKindOf(KINDOF_PROJECTILE))
    requiredMask |= WEAPON_COLLIDE_PROJECTILE;
  if (thingWeCollidedWith->getTemplate()->getFenceWidth() > 0)
    requiredMask |= WEAPON_COLLIDE_WALLS;
  if (thingWeCollidedWith->isKindOf(KINDOF_SMALL_MISSILE))
    requiredMask |=
        WEAPON_COLLIDE_SMALL_MISSILES; // All missiles are also projectiles!
  if (thingWeCollidedWith->isKindOf(KINDOF_BALLISTIC_MISSILE))
    requiredMask |=
        WEAPON_COLLIDE_BALLISTIC_MISSILES; // All missiles are also projectiles!

  // if any in requiredMask are present in collidemask, do the collision. (srj)
  if ((getProjectileCollideMask() & requiredMask) != 0)
    return true;

  // DEBUG_LOG(("Rejecting projectile collision between %s and
  // %s!",projectile->getTemplate()->getName().str(),thingWeCollidedWith->getTemplate()->getName().str()));
  return false;
}

//-------------------------------------------------------------------------------------------------
UnsignedInt WeaponTemplate::fireWeaponTemplate(
    const Object *sourceObj, WeaponSlotType wslot, Int specificBarrelToUse,
    Object *victimObj, const Coord3D *victimPos, const WeaponBonus &bonus,
    Bool isProjectileDetonation, Bool ignoreRanges, Weapon *firingWeapon,
    ObjectID *projectileID, Bool inflictDamage) const {
...
//-extraLogging
  ...
  if (TheGlobalData->m_extraLogging) {
    ...
    DEBUG_LOG(
        ("%d - WeaponTemplate::fireWeaponTemplate() begin - %s attacking %s",
         TheGameLogic->getFrame(), sourceObj->getTemplate()->getName().str(),
         targetStr.str()));
  }
#endif
  // end -extraLogging
  ...
  DEBUG_ASSERTCRASH(specificBarrelToUse >= 0,
                    ("specificBarrelToUse should no longer be -1"));

  if (sourceObj == nullptr || (victimObj == nullptr && victimPos == nullptr)) {
//-extraLogging
#if defined(RTS_DEBUG)
    if (TheGlobalData->m_extraLogging)
      DEBUG_LOG(("FAIL 1 (sourceObj %d == nullptr || (victimObj %d == nullptr "
                 "&& victimPos %d == nullptr)",
  ...
  DEBUG_ASSERTCRASH(
      (m_primaryDamage > 0) || (victimObj == nullptr),
      ("You can't really shoot a zero damage weapon at an Object."));
  ...
  if (victimObj) {
    DEBUG_ASSERTLOG(
        sourceObj != victimObj,
        ("*** firing weapon at self -- is this really what you want?"));
    ...
    if (ai != nullptr && ai->getSneakyTargetingOffset(&sneakyOffset)) {
      ...
      victimObj = nullptr;
      victimID = INVALID_ID;
      distSqr = ThePartitionManager->getDistanceSquared(sourceObj, victimPos,
                                                        ATTACK_RANGE_CALC_TYPE);
    } else {
      if (victimObj->isKindOf(KINDOF_BRIDGE)) {
        // Bridges are kind of oddball - they have 2 target points at either
        // end.
        TheTerrainLogic->getBridgeAttackPoints(victimObj, &info);
        distSqr = ThePartitionManager->getDistanceSquared(
            sourceObj, &info.attackPoint1, ATTACK_RANGE_CALC_TYPE);
        victimPos = &info.attackPoint1;
        Real distSqr2 = ThePartitionManager->getDistanceSquared(
            sourceObj, &info.attackPoint2, ATTACK_RANGE_CALC_TYPE);
        if (distSqr > distSqr2) {
          // Try the other one.
          distSqr = distSqr2;
        ...
        distSqr = ThePartitionManager->getDistanceSquared(
            sourceObj, victimObj, ATTACK_RANGE_CALC_TYPE);
      }
    }
  } else {
    victimID = INVALID_ID;
  ...
  // Only perform this check if the weapon isn't a leech range weapon (which can
  // have unlimited range!)
  if (!ignoreRanges && !isLeechRangeWeapon()) {
    Real attackRangeSqr = sqr(getAttackRange(bonus));
    if (distSqr > attackRangeSqr) {
// DEBUG_ASSERTCRASH(distSqr < 5*5 || distSqr < attackRangeSqr*1.2f, ("***
// victim is out of range (%f vs %f) of this weapon -- why did we attempt to
// fire?",sqrtf(distSqr),sqrtf(attackRangeSqr)));

//-extraLogging
#if defined(RTS_DEBUG)
      if (TheGlobalData->m_extraLogging)
        DEBUG_LOG(("FAIL 2 (distSqr %.2f > attackRangeSqr %.2f)", distSqr,
                   attackRangeSqr));
#endif
      // end -extraLogging
...
#endif
    {
      DEBUG_ASSERTCRASH(distSqr > minAttackRangeSqr * 0.8f,
                        ("*** victim is closer than min attack range (%f vs "
                         "%f) of this weapon -- why did we attempt to fire?",
                         sqrtf(distSqr), sqrtf(minAttackRangeSqr)));

//-extraLogging
#if defined(RTS_DEBUG)
      if (TheGlobalData->m_extraLogging)
        DEBUG_LOG(("FAIL 3 (distSqr %.2f< minAttackRangeSqr %.2f - 0.5f && "
                   "!isProjectileDetonation %d)",
  ...
  // call this even if FXList is null, because this also handles stuff like Gun
  // Barrel Recoil
  if (sourceObj && sourceObj->getDrawable()) {
    Coord3D targetPos;
    if (victimObj) {
      victimObj->getGeometryInfo().getCenterPosition(*victimObj->getPosition(),
                                                     targetPos);
    } else {
    ...
    Real reDir =
        reAngle != 0.0f
            ? (atan2(victimPos->y - sourcePos->y, victimPos->x - sourcePos->x))
            : 0.0f;
    VeterancyLevel v = sourceObj->getVeterancyLevel();
    const FXList *fx =
        isProjectileDetonation ? getProjectileDetonateFX(v) : getFireFX(v);
    ...
    // TheSuperHackers @todo: Remove hardcoded KINDOF_MINE check and apply
    // PlayFXWhenStealthed = Yes to the mine weapons instead.

    if (!sourceObj->isLogicallyVisible()     // if user watching cannot see us
        && !sourceObj->isKindOf(KINDOF_MINE) // and not a mine (which always do
                                             // the FX, even if hidden)...
        &&
        !isPlayFXWhenStealthed() // and not a weapon marked to playwhenstealthed
    ) {
      handled =
          TRUE; // then let's just pretend like we did the fx by returning true
    } else {
      handled = sourceObj->getDrawable()->handleWeaponFireFX(
          wslot, specificBarrelToUse, fx, getWeaponSpeed(), reAngle, reDir,
          &targetPos, getPrimaryDamageRadius(bonus));
    }

    if (handled == false && fx != nullptr) {
      // bah. just play it at the drawable's pos.
      // DEBUG_LOG(("*** WeaponFireFX not fully handled by the client"));
      const Coord3D *where = isContactWeapon()
                                 ? &targetPos
                                 : sourceObj->getDrawable()->getPosition();
      FXList::doFXPos(fx, where, sourceObj->getDrawable()->getTransformMatrix(),
                      getWeaponSpeed(), &targetPos,
  ...
  if (sourceObj) {
    VeterancyLevel v = sourceObj->getVeterancyLevel();
    const ObjectCreationList *oclToUse =
        isProjectileDetonation ? getProjectileDetonationOCL(v) : getFireOCL(v);
    if (oclToUse)
      ObjectCreationList::create(oclToUse, sourceObj, nullptr);
  }

  Coord3D projectileDestination =
      *victimPos; // Need to copy this, as we have a pointer to their actual
                  // position
  Real scatterRadius = 0.0f;
  if (m_scatterRadius > 0.0f || (m_infantryInaccuracyDist > 0.0f && victimObj &&
                                 victimObj->isKindOf(KINDOF_INFANTRY))) {
    // This weapon scatters, so clear the victimObj, as we are no longer
    // shooting it directly, and find a random point within the radius to shoot
    // at as victimPos
    ...
    if (victimObj) {
      if (victimObj->isKindOf(KINDOF_STRUCTURE)) {
        victimObj->getGeometryInfo().getCenterPosition(
            *victimObj->getPosition(), projectileDestination);
      }
      if (m_infantryInaccuracyDist > 0.0f &&
          victimObj->isKindOf(KINDOF_INFANTRY)) {
        // If we are firing a weapon that is considered inaccurate against
        // infantry, then add it to the scatter radius!
        scatterRadius += m_infantryInaccuracyDist;
      }
      targetLayer = victimObj->getLayer();
    }

    // victimObj = nullptr; // his position is already in victimPos, if he
    // existed

    // Randomize the scatter radius (sometimes it can be more accurate than
    // others)
    ...
    // What's suddenly become crucially important is to FIRE at the ground at
    // this location!!! If we aim for the center point of our target and miss,
    // the shot will go much farther than we expect!
    //  srj sez: we should actually fire at the layer the victim is on, if
    //  possible, in case it is on a bridge...
    projectileDestination.z = TheTerrainLogic->getLayerHeight(
  ...
  if (getProjectileTemplate() == nullptr || isProjectileDetonation) {
    ...
    if (firingWeapon->isLaser()) {
      if (scatterRadius <= getPrimaryDamageRadius(bonus) ||
          scatterRadius <= getSecondaryDamageRadius(bonus)) {
        // The laser is close enough to damage the object, so just hit it
        // directly. Some victim objects adjust the laser's position to prevent
        ...
        // We are missing our intended target, so now we want to aim at the
        // ground at the projectile offset.
        damageID = INVALID_ID;
        firingWeapon->createLaser(sourceObj, nullptr, &projectileDestination);
      }
      if (inflictDamage) {
        dealDamageInternal(sourceID, damageID, &projectileDestination, bonus,
                           isProjectileDetonation);
      }
      return TheGameLogic->getFrame();
    }

    const Coord3D *damagePos =
        getDamageDealtAtSelfPosition() ? sourcePos : victimPos;
    if (delayInFrames < 1.0f) {
      // go ahead and do it now
      // DEBUG_LOG(("WeaponTemplate::fireWeaponTemplate: firing weapon
      // immediately!"));
      if (inflictDamage) {
        dealDamageInternal(sourceID, damageID, damagePos, bonus,
                           isProjectileDetonation);
      }
...
//-extraLogging
      ...
      if (TheWeaponStore && inflictDamage) {
        ...
        // DEBUG_LOG(("WeaponTemplate::fireWeaponTemplate: firing weapon in %d
        // frames (= %d)!", delayInWholeFrames,when));
        TheWeaponStore->setDelayedDamage(this, damagePos, when, sourceID,
                                         damageID, bonus);
      }
...
//-extraLogging
  ...
  {
    Player *owningPlayer =
        sourceObj->getControllingPlayer(); // Need to know so missiles don't
                                           // collide with firer
    Object *projectile = TheThingFactory->newObject(
        getProjectileTemplate(), owningPlayer->getDefaultTeam());
    projectile->setProducer(sourceObj);

    // If the player has battle plans (America Strategy Center), then apply
    // those bonuses to this object if applicable. Internally it validates
    // certain kinds of objects. When projectiles are created, weapon bonuses
    // such as damage may get applied.
    ...
    firingWeapon->newProjectileFired(
        sourceObj, projectile, victimObj,
        victimPos); // The actual logic weapon needs to know this was created.
    ...
    if (pui) {
      ...
      if (scatterRadius > 0.0f) {
        // With a scatter radius, don't follow the victim (overriding the
        // intent).
        pui->projectileLaunchAtObjectOrPosition(
            nullptr, &projectileDestination, sourceObj, wslot,
            specificBarrelToUse, this, m_projectileExhausts[v]);
      } else {
        pui->projectileLaunchAtObjectOrPosition(
            victimObj, &projectileDestination, sourceObj, wslot,
            specificBarrelToUse, this, m_projectileExhausts[v]);
      }
    } else {
      // DEBUG_CRASH(("Projectiles should implement
      // ProjectileUpdateInterface!"));
      //  actually, this is ok, for things like Firestorm.... (srj)
      projectile->setPosition(&projectileDestination);
    }

    // If we're launching a missile at a unit with valid countermeasures, then
    // communicate it
    if (projectile->isKindOf(KINDOF_SMALL_MISSILE) && victimObj &&
        victimObj->hasCountermeasures()) {
      const AIUpdateInterface *ai = victimObj->getAI();
      ...
      if (ai && ai->getCurLocomotorSetType() != LOCOMOTORSET_SUPERSONIC) {
        // This function will determine now whether or not the fired projectile
        // will be diverted to an available decoy flare.
...
void WeaponTemplate::trimOldHistoricDamage() const {
  UnsignedInt expirationDate =
      TheGameLogic->getFrame() - TheGlobalData->m_historicDamageLimit;
...
//-------------------------------------------------------------------------------------------------
static Bool is2DDistSquaredLessThan(const Coord3D &a, const Coord3D &b,
                                    Real distSqr) {
...
//-------------------------------------------------------------------------------------------------
#if RETAIL_COMPATIBLE_CRC || PRESERVE_RETAIL_BEHAVIOR
void WeaponTemplate::processHistoricDamage(const Object *source,
                                           const Coord3D *pos) const {
  //
  /** @todo We need to rewrite the historic stuff ... if you fire 5 missiles,
  and the 5th,
  // one creates a firestorm ... and then half a second later another volley of
  5 missiles
  // come in, the second wave of 5 missiles would all do a historic weapon,
  making 5 more
  // firestorms (CBD) */
  //
  ...
  if (m_historicBonusCount > 0 && m_historicBonusWeapon != this) {
    ...
    UnsignedInt oldestThatWillCount =
        frameNow - m_historicBonusTime; // Anything before this frame is "more
                                        // than two seconds ago" eg
    for (HistoricWeaponDamageList::const_iterator it = m_historicDamage.begin();
         it != m_historicDamage.end(); ++it) {
      if (it->frame >= oldestThatWillCount &&
          is2DDistSquaredLessThan(*pos, it->location, radSqr)) {
        // This one is close enough in time and distance, so count it. This is
        // tracked by template since it applies across units, so don't try to
        // clear historicDamage on success in here.
        ++count;
      }
    }

    if (count >= m_historicBonusCount -
                     1) // minus 1 since we include ourselves implicitly
    {
      TheWeaponStore->createAndFireTempWeapon(m_historicBonusWeapon, source,
                                              pos);

      /** @todo E3 hack! Clear the list for now to make sure we don't have
       * multiple firestorms remove this when the branches merge back into one.
       * What is causing the multiple firestorms, who is to say ... this is a
       * plug, not a fix! */
...
void WeaponTemplate::processHistoricDamage(const Object *source,
  ...
  if (m_historicBonusCount > 0 && m_historicBonusWeapon != this) {
      ...
      for (HistoricWeaponDamageList::iterator it = m_historicDamage.begin();
        ...
        if (is2DDistSquaredLessThan(*pos, it->location, radSqr)) {
          ...
          if (++count == requiredCount) {
            TheWeaponStore->createAndFireTempWeapon(m_historicBonusWeapon,
                                                    source, pos);
    ...
    // add AFTER checking for historic stuff
    m_historicDamage.push_back(
        HistoricWeaponDamageInfo(TheGameLogic->getFrame(), *pos));
  }
}
#endif

//-------------------------------------------------------------------------------------------------
void WeaponTemplate::dealDamageInternal(ObjectID sourceID, ObjectID victimID,
                                        const Coord3D *pos,
  ...
  // DEBUG_LOG(("WeaponTemplate::dealDamageInternal: dealing damage %s at frame
  // %d",m_name.str(),TheGameLogic->getFrame()));

  // if there's a specific victim, use it's pos (overriding the value passed in)
  Object *primaryVictim = victimID ? TheGameLogic->findObjectByID(victimID)
                                   : nullptr; // might be null...
  if (primaryVictim) {
  ...
  if (getProjectileTemplate() == nullptr || isProjectileDetonation) {
    ...
    DEBUG_ASSERTCRASH(
        secondaryRadius >= primaryRadius || secondaryRadius == 0.0f,
    ...
    if (radius > 0.0f) {
      iter = ThePartitionManager->iterateObjectsInRange(pos, radius,
                                                        DAMAGE_RANGE_CALC_TYPE);
      curVictim = iter->firstWithNumeric(&curVictimDistSqr);
    } else {
      // DEBUG_ASSERTCRASH(primaryVictim != nullptr, ("weapons without radii
      // should always pass in specific victims"));
      //  check against victimID rather than primaryVictim, since we may have
      //  targeted a legitimate victim that got killed before the damage was
      //  dealt... (srj)
      // DEBUG_ASSERTCRASH(victimID != 0, ("weapons without radii should always
      // pass in specific victims"));
      iter = nullptr;
    ...
    for (; curVictim != nullptr;
         curVictim = iter ? iter->nextWithNumeric(&curVictimDistSqr)
                          : nullptr) {
      Bool killSelf = false;
      if (source != nullptr) {
        // anytime something is designated as the "primary victim" (ie, the
        // direct target of the weapon), we ignore all the "affects" flags.
        if (curVictim != primaryVictim) {
          ...
          if ((affects & WEAPON_KILLS_SELF) && source == curVictim) {
            ...
            // should object ever be allowed to damage themselves? methinks
            // not... exception: a few weapons allow this (eg, for suicide
            // bombers).
            if ((affects & WEAPON_AFFECTS_SELF) == 0) {
              // Remember that source is a missile for some units, and they
              // don't want to injure them'selves' either
              if (source == curVictim ||
                  source->getProducerID() == curVictim->getID()) {
            ...
            if (affects & WEAPON_DOESNT_AFFECT_SIMILAR) {
              // This means we probably are affecting allies, but don't want to
              // kill nearby members that are the same type as us. A good
              // example are a group of terrorists blowing themselves up. We
              // don't want to cause a domino effect that kills all of them.
              if (source->getTemplate()->isEquivalentTo(
                      curVictim->getTemplate()) &&
                  source->getRelationship(curVictim) == ALLIES) {
                continue;
              }
            }

            if ((affects & WEAPON_DOESNT_AFFECT_AIRBORNE) != 0 &&
                curVictim->isSignificantlyAboveTerrain()) {
              continue;
            }

            /*
                    The idea here is: if its our ally(/enemies), AND it's not
               the direct target, AND the weapon doesn't do radius-damage to
               allies(/enemies)... skip it.
            */
      ...
      if (allowedAngle < PI) {
        if (curVictim == nullptr || source == nullptr)
          continue; // We are directional damage, but can't figure out our
                    // direction.  Just bail.
        ...
        Vector3 damageVector(damageDirection.x, damageDirection.y,
                             damageDirection.z);
        sourceVector.Normalize();
        damageVector.Normalize();

        // These are now normalized, so the dot productis actually the Cos of
        // the angle they form A smaller Cos would mean a more obtuse angle
        if (Vector3::Dot_Product(sourceVector, damageVector) <
            Cos(allowedAngle))
          continue; // Too far to the side, can't hurt them.
      }

      // Grab the vector between the source object causing the damage and the
      // victim in order that we can simulate a shockwave pushing objects around
      ...
      if (damageInfo.in.m_shockWaveAmount > 0.0f) {
        ...
        // Guard against zero vector. Make vector straight up if that is the
        // case
      ...
      if (source && source->getControllingPlayer()) {
        damageInfo.in.m_sourcePlayerMask =
            source->getControllingPlayer()->getPlayerMask();
      }
      ...
      if (killSelf) {
        // Deal enough damage to kill yourself. I thought about getting the
        // current health and applying enough unresistable damage to die...
        // however it's possible that we have different types of deaths based on
        // damage type and/or the possibility to resist certain damage types and
        // surviving -- so instead, I'm blindly inflicting a very high value of
        // the intended damage type.
        damageInfo.in.m_amount = HUGE_DAMAGE_AMOUNT;
        // BodyModuleInterface* body = curVictim->getBodyModule();
        // if( body )
        //{
        //	Real curVictimHealth = curVictim->getBodyModule()->getHealth();
        //	damageInfo.in.m_amount = __max( damageInfo.in.m_amount,
        //curVictimHealth );
        // }
      }

      // if the damage-dealer is a projectile, designate the damage as done by
      // its launcher, not the projectile. this is much more useful for the
      // AI...
      ...
      // DEBUG_ASSERTLOG(damageInfo.out.m_noEffect,
      // ("WeaponTemplate::dealDamageInternal: dealt to %s %08lx: attempted %f,
      // actual %f (%f)", 	curVictim->getTemplate()->getName().str(),curVictim,
      //	damageInfo.in.m_amount, damageInfo.out.m_actualDamageDealt,
      //damageInfo.out.m_actualDamageClipped));
    }
  } else {
    DEBUG_CRASH(
        ("projectile weapons should never get dealDamage called directly"));
  }
}
...
//-------------------------------------------------------------------------------------------------
void WeaponStore::handleProjectileDetonation(
    const WeaponTemplate *wt, const Object *source, const Coord3D *pos,
    WeaponBonusConditionFlags extraBonusFlags, Bool inflictDamage) {
...
WeaponStore::findWeaponTemplate(const AsciiString &name) const {
  if (name.compareNoCase("None") == 0)
    return nullptr;
  const WeaponTemplate *wt =
      findWeaponTemplatePrivate(TheNameKeyGenerator->nameToKey(name));
...
void WeaponStore::update() {
  for (std::list<WeaponDelayedDamageInfo>::iterator ddi = m_weaponDDI.begin();
       ddi != m_weaponDDI.end();) {
    ...
    if (curFrame >= ddi->m_delayDamageFrame) {
      ...
      ddi->m_delayedWeapon->dealDamageInternal(
          ddi->m_delaySourceID, ddi->m_delayIntendedVictimID,
          &ddi->m_delayDamagePos, ddi->m_bonus, isProjectileDetonation);
...
//-------------------------------------------------------------------------------------------------
void WeaponStore::deleteAllDelayedDamage() { m_weaponDDI.clear(); }
...
void WeaponStore::setDelayedDamage(const WeaponTemplate *weapon,
                                   const Coord3D *pos, UnsignedInt whichFrame,
                                   ObjectID sourceID, ObjectID victimID,
                                   const WeaponBonus &bonus) {
...
/*static*/ void WeaponStore::parseWeaponTemplateDefinition(INI *ini) {
  ...
  WeaponTemplate *weapon = TheWeaponStore->findWeaponTemplatePrivate(
  ...
  if (weapon) {
    if (ini->getLoadType() == INI_LOAD_CREATE_OVERRIDES)
      ...
      DEBUG_CRASH(
          ("Weapon '%s' already exists, but OVERRIDE not specified", c));
      return;
    }
...
#if defined(RTS_DEBUG)
  if (!weapon->getFireSound().getEventName().isEmpty() &&
      weapon->getFireSound().getEventName().compareNoCase("NoSound") != 0) {
    DEBUG_ASSERTCRASH(TheAudio->isValidAudioEvent(&weapon->getFireSound()),
                      ("Invalid FireSound %s in Weapon '%s'.",
                       weapon->getFireSound().getEventName().str(),
                       weapon->getName().str()));
  }
#endif
}
...
Weapon::Weapon(const WeaponTemplate *tmpl, WeaponSlotType wslot) {
  ...
  m_pitchLimited = (m_template->getMinTargetPitch() > -PI ||
                    m_template->getMaxTargetPitch() < PI);
...
Weapon::Weapon(const Weapon &that) {
  ...
  this->m_pitchLimited = (m_template->getMinTargetPitch() > -PI ||
                          m_template->getMaxTargetPitch() < PI);
...
void Weapon::computeBonus(const Object *source,
  ...
  // CRCDEBUG_LOG(("Weapon::computeBonus() - flags are %X for %s", flags,
  // DescribeObject(source).str()));
  flags |= extraBonusFlags;

  if (source->getContainedBy()) {
    // We may be able to add in our container's flags
    const ContainModuleInterface *theirContain =
        source->getContainedBy()->getContain();
...
void Weapon::setClipPercentFull(Real percent, Bool allowReduction) {
  ...
  if (ammo > m_ammoInClip || (allowReduction && ammo < m_ammoInClip)) {
    ...
    // CRCDEBUG_LOG(("Weapon::setClipPercentFull() just set m_status to %d (ammo
    // in clip is %d)", m_status, m_ammoInClip));
    m_whenLastReloadStarted = TheGameLogic->getFrame();
    m_whenWeCanFireAgain = m_whenLastReloadStarted;
    // CRCDEBUG_LOG(("Just set m_whenWeCanFireAgain to %d in
    // Weapon::setClipPercentFull", m_whenWeCanFireAgain));
...
//-------------------------------------------------------------------------------------------------
void Weapon::reloadWithBonus(const Object *sourceObj, const WeaponBonus &bonus,
                             Bool loadInstantly) {
  if (m_template->getClipSize() > 0 &&
  ...
  // CRCDEBUG_LOG(("Just set m_whenWeCanFireAgain to %d in
  // Weapon::reloadWithBonus 1", m_whenWeCanFireAgain));
  ...
  if (sourceObj->isReloadTimeShared()) {
    for (Int wt = 0; wt < WEAPONSLOT_COUNT; wt++) {
      ...
      if (weapon) {
        ...
        // CRCDEBUG_LOG(("Just set m_whenWeCanFireAgain to %d in
        // Weapon::reloadWithBonus 2", m_whenWeCanFireAgain));
...
void Weapon::onWeaponBonusChange(const Object *source) {
  ...
  WeaponBonus bonus;
  computeBonus(source, 0, bonus); // The middle arg is for projectiles to
                                  // inherit damage bonus from launcher
...
//-------------------------------------------------------------------------------------------------
Bool Weapon::computeApproachTarget(const Object *source, const Object *target,
                                   const Coord3D *pos, Real angleOffset,
  ...
  if (target) {
    ...
    ThePartitionManager->getVectorTo(target, source, ATTACK_RANGE_CALC_TYPE,
                                     dir);
  } else if (pos) {
    targetPos = pos;
  ...
  if (minAttackRange > PATHFIND_CELL_SIZE_F && dist < minAttackRange) {
    ...
    DEBUG_ASSERTCRASH((minAttackRange < 0.9f * getAttackRange(source)),
                      ("Min attack range is too near attack range."));
    ...
    // select a spot along the line between us, halfway between the min & max
    // range.
  ...
  if (dist < FUDGE) {
    ...
    if (isContactWeapon()) {
      // Weapon is basically a contact weapon, like a car bomb.  The approach
      // target logic has been modified to let it approach the object, so just
      // return the target position.	jba.
    ...
    if (source->getAI() &&
        source->getAI()->isAircraftThatAdjustsDestination()) {
      // Adjust the target so that we are not stacked atop another aircraft.
      TheAI->pathfinder()->adjustTargetDestination(source, target, pos, this,
                                                   &approachTargetPos);
    }
...
//-------------------------------------------------------------------------------------------------
// Special case attack range calculate that fakes moving the object (to a
// garrisoned point) without actually moving the object. This is used to help
// determine if a garrisoned unit not yet positioned can attack someone.
//-------------------------------------------------------------------------------------------------
Bool Weapon::isSourceObjectWithGoalPositionWithinAttackRange(
  ...
  Real distSqr;
  if (target)
    distSqr = ThePartitionManager->getGoalDistanceSquared(
        source, goalPos, target, ATTACK_RANGE_CALC_TYPE);
  else if (targetPos)
    distSqr = ThePartitionManager->getGoalDistanceSquared(
        source, goalPos, targetPos, ATTACK_RANGE_CALC_TYPE);
  else
    return false;
...
Bool Weapon::isWithinAttackRange(const Object *source,
                                 const Coord3D *pos) const {
  Real distSqr = ThePartitionManager->getDistanceSquared(
      source, pos, ATTACK_RANGE_CALC_TYPE);
  Real attackRangeSqr = sqr(getAttackRange(source));
  Real minAttackRangeSqr = sqr(m_template->getMinimumAttackRange());
#ifdef RATIONALIZE_ATTACK_RANGE
  if (distSqr < minAttackRangeSqr)
...
Bool Weapon::isWithinAttackRange(const Object *source,
  ...
  if (!target->isKindOf(KINDOF_BRIDGE)) {
    distSqr = ThePartitionManager->getDistanceSquared(source, target,
                                                      ATTACK_RANGE_CALC_TYPE);
  } else {
    ...
    distSqr = ThePartitionManager->getDistanceSquared(
        source, &info.attackPoint1, ATTACK_RANGE_CALC_TYPE);
    if (distSqr > attackRangeSqr) {
      // Try the other one.
      distSqr = ThePartitionManager->getDistanceSquared(
          source, &info.attackPoint2, ATTACK_RANGE_CALC_TYPE);
    }
  }
  ...
  if (distSqr <= attackRangeSqr) {
    // Note - only compare contact weapons with structures.  If you do the
    // collision check against vehicles, the attacker may get close enough to
    // the vehicle to get crushed before it fires its weapon.  jba.
    if (isContactWeapon() && target->isKindOf(KINDOF_STRUCTURE)) {
      // We're close enough to fire off ranged weapons -- but in the case of
      // contact weapons we want to do a more detailed check to see if we're
      // actually colliding with the target.
      ObjectIterator *iter = ThePartitionManager->iteratePotentialCollisions(
          source->getPosition(), source->getGeometryInfo(), 0.0f);
      MemoryPoolObjectHolder hold(iter);
...
Bool Weapon::isTooClose(const Object *source, const Object *target) const {
  ...
  Real distSqr = ThePartitionManager->getDistanceSquared(
      source, target, ATTACK_RANGE_CALC_TYPE);
...
Bool Weapon::isGoalPosWithinAttackRange(const Object *source,
  ...
  Real distSqr;
  // Note - undersize by 1/4 of a pathfind cell, so that the goal is not
  // teetering on the edge of firing range.  jba. Note 2 - even with
  // RATIONALIZE_ATTACK_RANGE, we still need to subtract 1/4 of a pathfind cell,
  // otherwise if it teters on the edge, attacks can fail.  jba.
  Real attackRangeSqr =
      sqr(getAttackRange(source) - (PATHFIND_CELL_SIZE_F * 0.25f));
  ...
  if (target != nullptr) {
    if (target->isKindOf(KINDOF_BRIDGE)) {
      ...
      TheTerrainLogic->getBridgeAttackPoints(target, &info);
      distSqr = ThePartitionManager->getGoalDistanceSquared(
          source, goalPos, &info.attackPoint1, ATTACK_RANGE_CALC_TYPE);
      if (distSqr > attackRangeSqr) {
        // Try the other one.
        distSqr = ThePartitionManager->getGoalDistanceSquared(
            source, goalPos, &info.attackPoint2, ATTACK_RANGE_CALC_TYPE);
      }
    } else {
      distSqr = ThePartitionManager->getGoalDistanceSquared(
          source, goalPos, target, ATTACK_RANGE_CALC_TYPE);
  ...
  // Note - oversize by 1/4 of a pathfind cell, so that the goal is not
  // teetering on the edge of firing range.  jba. Note 2 - even with
  // RATIONALIZE_ATTACK_RANGE, we still need to add 1/4 of a pathfind cell,
  // otherwise if it teters on the edge, attacks can fail.  jba.
  Real minAttackRangeSqr =
      sqr(m_template->getMinimumAttackRange() + (PATHFIND_CELL_SIZE_F * 0.25f));
#ifdef RATIONALIZE_ATTACK_RANGE
  if (distSqr < minAttackRangeSqr)
#else
  if (distSqr < minAttackRangeSqr - 0.5f)
...
Real Weapon::getPercentReadyToFire() const {
  ...
  case RELOADING_CLIP: {
    ...
    DEBUG_ASSERTCRASH(now >= m_whenLastReloadStarted,
                      ("now >= m_whenLastReloadStarted"));
    if (now >= nextShot)
      return 1.0f;

    DEBUG_ASSERTCRASH(nextShot >= m_whenLastReloadStarted,
                      ("nextShot >= m_whenLastReloadStarted"));
...
//-------------------------------------------------------------------------------------------------
Real Weapon::getAttackDistance(const Object *source, const Object *victimObj,
...
Real Weapon::estimateWeaponDamage(const Object *sourceObj,
  ...
  return m_template->estimateWeaponTemplateDamage(sourceObj, victimObj,
                                                  victimPos, bonus);
}
...
void Weapon::newProjectileFired(const Object *sourceObj,
  ...
  if (projectileStream == nullptr) {
    m_projectileStreamID = INVALID_ID; // reset, since it might have been
                                       // "valid" but deleted out from under us
    const ThingTemplate *pst =
        TheThingFactory->findTemplate(m_template->getProjectileStreamName());
    projectileStream = TheThingFactory->newObject(
        pst, sourceObj->getControllingPlayer()->getDefaultTeam());
    if (projectileStream == nullptr)
      return;
  ...
  static NameKeyType key_ProjectileStreamUpdate =
      NAMEKEY("ProjectileStreamUpdate");
  ProjectileStreamUpdate *update =
      (ProjectileStreamUpdate *)projectileStream->findUpdateModule(
          key_ProjectileStreamUpdate);
  if (update) {
    update->setPosition(sourceObj->getPosition());
    update->addProjectile(sourceObj->getID(), projectile->getID(),
                          victimObj ? victimObj->getID() : INVALID_ID,
                          victimPos);
    return;
  }
}
...
//-------------------------------------------------------------------------------------------------
void Weapon::createLaser(const Object *sourceObj, const Object *victimObj,
                         const Coord3D *victimPos) {
  const ThingTemplate *pst =
      TheThingFactory->findTemplate(m_template->getLaserName());
  if (!pst) {
    DEBUG_CRASH(
        ("Weapon::createLaser(). %s could not find template for its laser %s.",
         sourceObj->getTemplate()->getName().str(),
         m_template->getLaserName().str()));
    return;
  }
  Object *laser = TheThingFactory->newObject(
      pst, sourceObj->getControllingPlayer()->getDefaultTeam());
  if (laser == nullptr)
    return;
  ...
  if (draw) {
    ...
    if (update) {
      ...
      if (victimObj && !victimObj->isKindOf(KINDOF_PROJECTILE) &&
          !victimObj->isAirborneTarget()) {
        // Targets are positioned on the ground, so raise the beam up so we're
        // not shooting their feet. Projectiles are a different story, target
        // their exact position.
        pos.z += 10.0f;
      }
      update->initLaser(sourceObj, victimObj, sourceObj->getPosition(), &pos,
                        m_template->getLaserBoneName());
    }
  }
}
...
Bool Weapon::privateFireWeapon(const Object *sourceObj, Object *victimObj,
                               const Coord3D *victimPos,
                               Bool isProjectileDetonation, Bool ignoreRanges,
                               WeaponBonusConditionFlags extraBonusFlags,
                               ObjectID *projectileID, Bool inflictDamage) {
  // CRCDEBUG_LOG(("Weapon::privateFireWeapon() for %s",
  // DescribeObject(sourceObj).str())); USE_PERF_TIMER(fireWeapon)
  if (projectileID)
  ...
  // If we are a networked weapon, tell everyone nearby they might want to get
  // in on this shot
  if (m_template->getRequestAssistRange() && victimObj)
    processRequestAssistance(sourceObj, victimObj);

  // For weapon templates that have the leech range weapon flag set, it
  // essentially grants the weapon unlimited range for the remainder of the
  // attack. While it's triggered here it's the AIAttackState machine that
  // actually uses and resets this value. This makes the ASSUMPTION that it is
  // IMPOSSIBLE TO FIRE A WEAPON WITHOUT BEING IN AN AIATTACKSTATE
  //
  //  @todo srj -- this isn't a universally true assertion! eg, FireWeaponDie
  ...
  case DAMAGE_DEPLOY: {
    ...
    if (ai) {
      const AssaultTransportAIInterface *atInterface =
          ai->getAssaultTransportAIInterface();
      if (atInterface) {
  ...
  case DAMAGE_DISARM: {
    if (sourceObj && victimObj) {
      Bool found = false;
      for (BehaviorModule **bmi = victimObj->getBehaviorModules(); *bmi;
           ++bmi) {
        LandMineInterface *lmi = (*bmi)->getLandMineInterface();
        if (lmi) {
          VeterancyLevel v = sourceObj->getVeterancyLevel();
          FXList::doFXPos(m_template->getFireFX(v), victimObj->getPosition(),
                          victimObj->getTransformMatrix(), 0,
                          victimObj->getPosition(), 0);
          lmi->disarm();
          found = true;
          break;
        }
      ...
      if ((!found && victimObj->isKindOf(KINDOF_MINE)) ||
        ...
        TheGameLogic->destroyObject(
            victimObj); // douse this thing before somebody gets hurt!
        found = true;
      }

      if (found) {
        sourceObj->getControllingPlayer()
            ->getAcademyStats()
            ->recordMineCleared();
      }
    }
    ...
    --m_maxShotCount;
    --m_ammoInClip; // so we can use the delay between shots on the mine
                    // clearing weapon
  ...
  case DAMAGE_HACK: {
    // We're using a hacker unit to hack a target. Hacking has various effects
    // and instead of inflicting damage, we are waiting for a period of time
    // until the hack takes effect. return FALSE;
  }
  }
  ...
  DEBUG_ASSERTCRASH(getStatus() != OUT_OF_AMMO,
                    ("Hmm, firing weapon that is OUT_OF_AMMO"));
  DEBUG_ASSERTCRASH(
      getStatus() == READY_TO_FIRE,
      ("Hmm, Weapon is firing more often than should be possible"));
  ...
  if (m_ammoInClip > 0) {
    ...
    if (!m_scatterTargetsUnused.empty()) {
      // If I have a set scatter pattern, I need to offset the target by a
      // random pick from that pattern
      if (victimObj) {
        victimPos = victimObj->getPosition();
        victimObj = nullptr;
      }
      Coord3D targetPos = *victimPos; // need to copy, as this pointer is
                                      // actually inside somebody potentially
      Int randomPick =
          GameLogicRandomValue(0, m_scatterTargetsUnused.size() - 1);
      Int targetIndex = m_scatterTargetsUnused[randomPick];

      Real scatterTargetScalar =
          getScatterTargetScalar(); // essentially a radius, but operates only
                                    // on this scatterTarget table
      Coord2D scatterOffset =
          m_template->getScatterTargetsVector().at(targetIndex);
      ...
      // To erase from a vector, put the last on the one you used and pop the
      // back.
      m_scatterTargetsUnused[randomPick] = m_scatterTargetsUnused.back();
      m_scatterTargetsUnused.pop_back();
      m_template->fireWeaponTemplate(sourceObj, m_wslot, m_curBarrel, victimObj,
                                     &targetPos, bonus, isProjectileDetonation,
                                     ignoreRanges, this, projectileID,
                                     inflictDamage);
    } else {
      m_template->fireWeaponTemplate(sourceObj, m_wslot, m_curBarrel, victimObj,
                                     victimPos, bonus, isProjectileDetonation,
                                     ignoreRanges, this, projectileID,
                                     inflictDamage);
    }
    ...
    if (m_ammoInClip <= 0) {
      if (m_template->getAutoReloadsClip()) {
        ...
        // CRCDEBUG_LOG(("Just set m_whenWeCanFireAgain to %d in
        // Weapon::privateFireWeapon 1", m_whenWeCanFireAgain));
      }
    } else {
      m_status = BETWEEN_FIRING_SHOTS;
      // CRCDEBUG_LOG(("Weapon::privateFireWeapon() just set m_status to
      ...
      // CRCDEBUG_LOG(("Just set m_whenWeCanFireAgain to %d (delay is %d) in
      // Weapon::privateFireWeapon", m_whenWeCanFireAgain, delay));
      ...
      if (sourceObj->isReloadTimeShared()) {
        for (Int wt = 0; wt < WEAPONSLOT_COUNT; wt++) {
          ...
          if (weapon) {
            weapon->setPossibleNextShotFrame(m_whenWeCanFireAgain);
            // CRCDEBUG_LOG(("Just set m_whenWeCanFireAgain to %d in
            // Weapon::privateFireWeapon 3", m_whenWeCanFireAgain));
...
//-------------------------------------------------------------------------------------------------
Bool Weapon::fireWeapon(const Object *source, Object *target,
                        ObjectID *projectileID) {
  // CRCDEBUG_LOG(("Weapon::fireWeapon() for %s at %s",
  // DescribeObject(source).str(), DescribeObject(target).str()));
  return privateFireWeapon(source, target, nullptr, false, false, 0,
                           projectileID, TRUE);
}

//-------------------------------------------------------------------------------------------------
// return true if we auto-reloaded our clip after firing.
Bool Weapon::fireWeapon(const Object *source, const Coord3D *pos,
                        ObjectID *projectileID) {
...
//-------------------------------------------------------------------------------------------------
void Weapon::fireProjectileDetonationWeapon(
    const Object *source, Object *target,
    WeaponBonusConditionFlags extraBonusFlags, Bool inflictDamage) {
  // CRCDEBUG_LOG(("Weapon::fireProjectileDetonationWeapon() for %sat %s",
  // DescribeObject(source).str(), DescribeObject(target).str()));
  privateFireWeapon(source, target, nullptr, true, false, extraBonusFlags,
                    nullptr, inflictDamage);
}

//-------------------------------------------------------------------------------------------------
void Weapon::fireProjectileDetonationWeapon(
    const Object *source, const Coord3D *pos,
    WeaponBonusConditionFlags extraBonusFlags, Bool inflictDamage) {
...
// and immediately gain control of the weapon that was fired to give it special
// orders...
Object *Weapon::forceFireWeapon(const Object *source, const Coord3D *pos) {
  // CRCDEBUG_LOG(("Weapon::forceFireWeapon() for %s",
  // DescribeObject(source).str())); Force the ammo to load instantly.
  // loadAmmoNow( source );
  // Fire the weapon at the position. Internally, it'll store the weapon
  // projectile ID if so created.
...
WeaponStatus Weapon::getStatus() const {
  ...
  if (now >= m_whenWeCanFireAgain) {
    if (m_ammoInClip > 0)
      ...
      m_status = OUT_OF_AMMO;
    // CRCDEBUG_LOG(("Weapon::getStatus() just set m_status to %d (ammo in clip
    // is %d)", m_status, m_ammoInClip));
  }
  return m_status;
}
...
Bool Weapon::isWithinTargetPitch(const Object *source,
  ...
  source->getGeometryInfo().calcPitches(*src, victim->getGeometryInfo(), *dst,
                                        minPitch, maxPitch);

  // if there's any intersection between the the two pitch ranges, we're good to
  // go.
  if ((minPitch >= m_template->getMinTargetPitch() &&
       minPitch <= m_template->getMaxTargetPitch()) ||
      (maxPitch >= m_template->getMinTargetPitch() &&
       maxPitch <= m_template->getMaxTargetPitch()) ||
      (minPitch <= m_template->getMinTargetPitch() &&
       maxPitch >= m_template->getMaxTargetPitch()))
    return true;

  // DEBUG_LOG(("pitch %f-%f is out of
  // range",rad2deg(minPitch),rad2deg(maxPitch),rad2deg(m_template->getMinTargetPitch()),rad2deg(m_template->getMaxTargetPitch())));
  return false;
}
...
Bool Weapon::isDamageWeapon() const {
  ...
  case DAMAGE_DEPLOY:
    // Kris @todo
    // Evaluate a better way to handle this weapon type... doesn't fit being a
    // damage weapon. May want to check if cargo can attack!
    return TRUE;
  ...
  if (m_template->getPrimaryDamage(whoCares) > 0.0f ||
      m_template->getSecondaryDamage(whoCares) > 0.0f) {
    return TRUE;
  }
...
static void makeAssistanceRequest(Object *requestOf, void *userData) {
  ...
  if (!requestOf->getTemplate()->isEquivalentTo(
          requestData->m_requestingObject->getTemplate()))
    return;

  // Who are close enough
  Real distSq = ThePartitionManager->getDistanceSquared(
      requestOf, requestData->m_requestingObject, FROM_CENTER_2D);
  if (distSq > requestData->m_requestDistanceSquared)
    return;

  // and respond to requests
  static const NameKeyType key_assistUpdate =
      NAMEKEY("AssistedTargetingUpdate");
  AssistedTargetingUpdate *assistModule =
      (AssistedTargetingUpdate *)requestOf->findUpdateModule(key_assistUpdate);
  ...
  assistModule->assistAttack(requestData->m_requestingObject,
                             requestData->m_victimObject);
}

//-------------------------------------------------------------------------------------------------
void Weapon::processRequestAssistance(const Object *requestingObject,
                                      Object *victimObject) {
  // Iterate through our player's objects, and tell everyone like us within our
  // assistance range who is free to do so to assist us on this shot.
  ...
  requestData.m_requestDistanceSquared =
      m_template->getRequestAssistRange() * m_template->getRequestAssistRange();

  ourPlayer->iterateObjects(makeAssistanceRequest, &requestData);
}

//-------------------------------------------------------------------------------------------------
/*static*/ void Weapon::calcProjectileLaunchPosition(const Object *launcher,
                                                     WeaponSlotType wslot,
                                                     Int specificBarrelToUse,
                                                     Matrix3D &worldTransform,
                                                     Coord3D &worldPos) {
  if (launcher->getContainedBy()) {
    // If we are in an enclosing container, our launch position is our actual
    // position.  Yes, I am putting a minor case and an oft used function, but
    // the major case is huge and full of math.
    if (launcher->getContainedBy()->getContain()->isEnclosingContainerFor(
            launcher)) {
  ...
  WhichTurretType tur =
      ai ? ai->getWhichTurretForWeaponSlot(wslot, &turretAngle, &turretPitch)
         : TURRET_INVALID;
  // CRCDEBUG_LOG(("calcProjectileLaunchPosition(): Turret %d, slot %d, barrel
  // %d for %s", tur, wslot, specificBarrelToUse,
  // DescribeObject(launcher).str()));
  ...
  if (!draw || !draw->getProjectileLaunchOffset(
                   wslot, specificBarrelToUse, &attachTransform, tur,
                   &turretRotPos, &turretPitchPos)) {
    // CRCDEBUG_LOG(("ProjectileLaunchPos %d %d not found!",wslot,
    // specificBarrelToUse));
    DEBUG_CRASH(
        ("ProjectileLaunchPos %d %d not found!", wslot, specificBarrelToUse));
    attachTransform.Make_Identity();
    turretRotPos.zero();
    turretPitchPos.zero();
  }
  if (tur != TURRET_INVALID) {
    // The attach transform is the pristine front and center position of the
    // fire point We can't read from the client, so we need to reproduce the
    // actual point that takes turn and pitch into account.
    Matrix3D turnAdjustment(1);
    Matrix3D pitchAdjustment(1);

    // To rotate about a point, move that point to 0,0, rotate, then move it
    // back. Pre rotate will keep the first twist from screwing the angle of the
    // second pitch
    pitchAdjustment.Translate(turretPitchPos.x, turretPitchPos.y,
                              turretPitchPos.z);
  ...
  //   DEBUG_ASSERTCRASH( muzzleHeight > 0.001f, ("YOUR TURRET HAS A VERY LOW
  //   PROJECTILE LAUNCH POSITION, BUT FOUND A VALID BONE. DID YOU PICK THE
  //   WRONG ONE? %s", launcher->getTemplate()->getName().str()));
  // #endif

  launcher->convertBonePosToWorldPos(nullptr, &attachTransform, nullptr,
                                     &worldTransform);
...
//-------------------------------------------------------------------------------------------------
/*static*/ void Weapon::positionProjectileForLaunch(Object *projectile,
  ...
  Weapon::calcProjectileLaunchPosition(launcher, wslot, specificBarrelToUse,
...
void Weapon::getFiringLineOfSightOrigin(const Object *source,
  ...
  // GS 1-6-03
  //  Sorry, but we have to simplify this.  If we take the actual projectile
  //  launch pos, then that point can change. Take a Ranger with his gun on his
  //  shoulder.  His point is very high so he clears this check and transitions
  //  to attacking.  This puts his gun at waist level and now he fails this
  //  check so he transitions back.  Our height won't change.
  ...
  /*
          if (m_template->getProjectileTemplate() == nullptr)
          {
                  ...
                  // to their head than their feet. if we have really odd
     critters
                  // with eye-feet, we'll need to change this assumption.)
                  origin.z +=
     source->getGeometryInfo().getMaxHeightAbovePosition();
          }
          else
          {
                  Matrix3D tmp(true);
                  Coord3D launchPos = {0.0f, 0.0f, 0.0f};
                  calcProjectileLaunchPosition(source, m_wslot, m_curBarrel,
     tmp, launchPos); origin.x += launchPos.x - source->getPosition()->x;
...
Bool Weapon::isClearFiringLineOfSightTerrain(const Object *source,
  ...
  // DescribeObject(source).str())); DUMPCOORD3D(&origin);
  getFiringLineOfSightOrigin(source, origin);
  Coord3D victimPos;
  victim->getGeometryInfo().getCenterPosition(*victim->getPosition(),
                                              victimPos);
  // CRCDEBUG_LOG(("Weapon::isClearFiringLineOfSightTerrain() - victimPos is
  // (%g,%g,%g) (%X,%X,%X)", 	victimPos.x, victimPos.y, victimPos.z,
  //	AS_INT(victimPos.x),AS_INT(victimPos.y),AS_INT(victimPos.z)));
  return ThePartitionManager->isClearLineOfSightTerrain(nullptr, origin,
                                                        nullptr, victimPos);
}
...
//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
/** Determine whether if source was at goalPos whether it would have clear line
 * of sight. */
...
/** Determine whether if source was at goalPos whether it would have clear line
 * of sight. */
Bool Weapon::isClearGoalFiringLineOfSightTerrain(
    const Object *source, const Coord3D &goalPos,
    const Coord3D &victimPos) const {
  Coord3D origin = goalPos;
  // CRCDEBUG_LOG(("Weapon::isClearGoalFiringLineOfSightTerrain(Coord3D) for
  // %s", DescribeObject(source).str())); DUMPCOORD3D(&origin);
  getFiringLineOfSightOrigin(source, origin);
  // CRCDEBUG_LOG(("Weapon::isClearFiringLineOfSightTerrain() - victimPos is
  // (%g,%g,%g) (%X,%X,%X)", 	victimPos.x, victimPos.y, victimPos.z,
  //	AS_INT(victimPos.x),AS_INT(victimPos.y),AS_INT(victimPos.z)));
...
// This function was added to transfer key weapon stats for Jarmen Kell to and
// from the bike for the sniper attack, so he can share the stats.
//-------------------------------------------------------------------------------------------------
...
void Weapon::crc(Xfer *xfer) {
  ...
  */
  ...
  for (it = m_scatterTargetsUnused.begin(); it != m_scatterTargetsUnused.end();
       ++it) {
...
void Weapon::xfer(Xfer *xfer) {
  ...
  if (xfer->getXferMode() == XFER_SAVE) {
    ...
    for (it = m_scatterTargetsUnused.begin();
         it != m_scatterTargetsUnused.end(); ++it) {
...
void Weapon::loadPostProcess() {
  if (m_projectileStreamID != INVALID_ID) {
    Object *projectileStream =
        TheGameLogic->findObjectByID(m_projectileStreamID);
    if (projectileStream == nullptr) {
      m_projectileStreamID = INVALID_ID;
    }
  }
...
//-------------------------------------------------------------------------------------------------
/*static*/ void WeaponBonusSet::parseWeaponBonusSet(INI *ini,
                                                    void * /*instance*/,
                                                    void *store,
                                                    const void * /*userData*/) {
...
//-------------------------------------------------------------------------------------------------
/*static*/ void
WeaponBonusSet::parseWeaponBonusSetPtr(INI *ini, void * /*instance*/,
...
void WeaponBonusSet::parseWeaponBonusSet(INI *ini) {
  WeaponBonusConditionType wb = (WeaponBonusConditionType)INI::scanIndexList(
      ini->getNextToken(), TheWeaponBonusNames);
  WeaponBonus::Field wf = (WeaponBonus::Field)INI::scanIndexList(
      ini->getNextToken(), TheWeaponBonusFieldNames);
  m_bonus[wb].setField(wf, INI::scanPercentToReal(ini->getNextToken()));
}

//-------------------------------------------------------------------------------------------------
void WeaponBonusSet::appendBonuses(WeaponBonusConditionFlags flags,
                                   WeaponBonus &bonus) const {
  if (flags == 0)
